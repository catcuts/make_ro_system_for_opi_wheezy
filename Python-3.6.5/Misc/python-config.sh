...
SYSLIBS="$LIBM $LIBC"
ABIFLAGS="m"
LIBS="-lpython${VERSION}${ABIFLAGS} -lpthread -ldl  -lutil -lrt $SYSLIBS"
...
LIBPL=$(echo "$(prefix)/lib/python3.6/config-$(VERSION)$(ABIFLAGS)-arm-linux-gnueabihf" | sed "s#$prefix#$prefix_real#")
